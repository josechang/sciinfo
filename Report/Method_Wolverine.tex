...
This study already listed some differences between SQL and NoSQL shown in Figure \ref{WMC3}.
...
\begin{enumerate}
	...
	When it comes to the dynamic pages,	Web crawler needs to first pass the original html to a javascript rendering program or a light weight browser. 
