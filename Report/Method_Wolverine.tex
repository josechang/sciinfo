...
>>>>>>> origin/DexterChen/make-the-size-of-sentence-suitable-to-th-1464311380447

>>>>>>> 6d83ddc69b7fd82a83d71f146a2a1242b75066e4
	...
	Graph database has several advantages to a relational database. A graph database is often faster for associative data set and map more directly to the structure of object-oriented applications. They can scale more naturally to large data sets as they do not typically require expensive join operations. As they depend on less on a rigid schema, they are more suitable to manage ad hoc and changing data with an evolving schema.
