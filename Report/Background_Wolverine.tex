...
\begin{enumerate}
    ...
    EBSCOhost promises a large number of databases. Many of them, such as MEDLINE and EconLit, are licensed from web content vendors.
    ...
    And the only one database which does not provide full-text documents is PubMed. 
