...
We live in the time where technologies evolve beyond our imagination.\todo{How can technology evolve beyond our imagination? Please rephrase.}
Information growth in a exponential rate according to \todo{Use proper citations} $Tague1981$, thus we can't rely on the old fashion ways to find data we want. 
...
They can only search the data that has been captured into the database according to $Grehan2002$. 
...
The comparison between three kinds of library can be found on Figure \ref{WBC1}. \todo{A figure should ideally be placed on the same page where it is referred to the first time. Definitely not several pages of text later. Just move the code for the figure here.}
