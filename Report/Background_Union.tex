...
The method to improve the problem above is "categorize the words based on different subjects,topic or genres" by using online database. Metadata is limited in digital libraries and web resources, try to enlarge them with meaningful, organized and desired categories \cite{Kules2006}.\todo{Check how to use citations in APA style.}
...
Natural language generation (NLG) is one branch of natural language processing. The goal is generating the words human being using via machine automatically. To use this technique, six basic activities are done: (a) content determination, (b) discourse planning, (c) sentence aggregation, (d) lexicalization, (e) referring expression generation, and (f) linguistic realization \cite{Ramos-Soto2015}. Some of the activities are mentioned above.\todo{Where? Please explain the 6 terms. What are they?} The advantage of this technique is that it is flexible, since there is no standardization. But it also has the difficulty in the implication of this technique.\cite{Ramos-Soto2015}
