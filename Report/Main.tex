...
\begin{document} 
	...
	2016 user tory: As A user I NEED (i) a system that include (ii) a database that (iii) has at least 10,000 articles.
	...
	2017 user story: As a researcher, I need a PDF reader where I can click on highlighted text and thereby perform a full text search in an article database and get a presentation of extracts of the most similar parts in decreasing order with the source mentioned on Harvard citation format with the title of the publication, its type and link to the publisher’s full text PDF and my library’s full text PDF, so that I rapidly can find more information about any part that interests me.
