...
\begin{document} 
	...
	\author{Torbjörn Nordling, \\Eric Lee, Jacky Wu, Karthick Mani, \\Eric Chang, Dexter Cheng, Peter Cheng}  % Please add your name here
	\maketitle   
	...
	%\include{Team_Union} % Change it to your .tex filename
	%\include{Eagle_Unit} % Change it to your .tex filename
