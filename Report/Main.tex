...
\usepackage{wrapfig} %figure position
...
\begin{document} 
	...
	\author{Bernie Huan, Chinweze Ubadigha, Dexter Chen, Eric Chang, Eric Lee, \\
		...
		Jones Hou, Karthick Mani, Kenny Hsu, Piyarul Hoque, Rahul Aditya, Tan Phat, Ray Chang, Wei, \\
		Yu-cheng Chen, Torbjörn E. M. Nordling}  % Please add your name here in alphabetic order (except Prof. N who is last)
	\maketitle   
