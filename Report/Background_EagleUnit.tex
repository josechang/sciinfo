...
\begin{enumerate}
	...
	then you need to modify the marcxml.bat file to include an xml parser in the classpath. 
	The unzip the marcxml.zip file in a directory and run marcxml.bat for more instructions. Make sure java is in your PATH.
