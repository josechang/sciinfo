...
To make the database be functional for the user to receive the articles they're seeking,
our responsibility will be creating an interface between the user, the database, and the searching programme. 
In the other words, we're going to construct a webpage with a search bar for the user to enter their search string,
And can display the search result given by the search system. 
