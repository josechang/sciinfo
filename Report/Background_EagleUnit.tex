...
\begin{enumerate}
	...
	Which carried out a literature review on the origin of MARC and its development in the MARC 21 and the coding records. Thus, it is presented coding with XML and the MARCXML schema, as well as criticism of the MARC formats 21. 
	It follows that, despite the criticism, the MARC formats 21 are still widely used and disseminated, and despite the advantages offered by XML, encoding with the ISO 2709 standard. \\
	...
	We hoped that the MARC formats 21, on development and on their encodings have contributed to the area of Information Science. \\
