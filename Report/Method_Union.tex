...
\begin{enumerate}
	...
	\item label: We check every phrase with the corpus which contain specific words like people name. Then we labele the words and store to the new list. At last, we write the information to the xml file. 
\end{enumerate}
