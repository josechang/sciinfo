...
class change_image_0_id extends CI_Model{
...
// echo 123;
       ...
       imagettftext($img, $font_size, $rotation, $origin_x, $origin_y, $black ,$font, $text);
         ...
         // imagefilledrectangle($img, 65, 95,($cut[0]/$max_x)*900+65, 105, $red);
         // imagefilledrectangle($img, ($cut[0]/$max_x)*900+65, 95,($cut[1]/$max_x)*900+65 , 105, $blue);
       // echo count($data_num);
       $arr2=[];
...
// echo $cc;
       for($i=0;$i<$cc;$i++){
                 ...
                 array_push($arr2, ($i*900/$max_x)+65);
       ...
       array_push($arr2, (($cc+1)*900/$max_x)+65);// +1 是設終點  最後一點
       array_push($arr2, 89.9);
