...
class change_image extends CI_Model{
...
// echo 123;
       ...
       array_push($arr2, (count($data_num)*1100/$max_x)+65);// +1 是設終點  最後一點
       array_push($arr2, 89.9);

       imagefilledpolygon($img, $arr2, count($data_num)+2,$green);//+2因為頭尾是自己+的  所以陣列長度+2
