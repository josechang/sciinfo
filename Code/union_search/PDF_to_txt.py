...
xml=open('Cobelli1979_Identifiability_of_compartmental_systems_and_related_structural_properties.txt','w')

for i in xrange(len(text)):
    xml.write(text[i])
xml.close()

myfile = open("Cobelli1979_Identifiability_of_compartmental_systems_and_related_structural_properties.txt")
