...
var ZeroUpload = {
	...
	url: 'static/', // set this to your server API endpoint
	maxFiles: 0, // max files to allow at once, 0 = infinite
	maxBytes: 10000000, // max bytes to allow at once, 0 = infinite
	acceptTypes: 'application/pdf', // file mime types to accept
