...
from year_extraction_cp1 import year_extractor ##5/8新增>>匯入Michael的year_extraction_cp1
...
def get_text(request):
    ...
    if 'q' in request.GET:
    ...
    elif 'q' in request.GET and 'check' in request.GET:     #####0508新增部分
        ...
        # implement searching function and ranks
        yearsort=year_extractor(pdf_path, pdf_filename)
        resultlist = []
        for i in yearsort:
            resultlist.append(i)
            resultlist.sort()
